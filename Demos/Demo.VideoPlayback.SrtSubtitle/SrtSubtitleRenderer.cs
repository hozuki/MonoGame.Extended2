...
namespace Demo.VideoPlayback.SrtSubtitle {
    public class SrtSubtitleRenderer : SubtitleRenderer {
        ...
        public SrtSubtitleRenderer([NotNull] GraphicsDevice graphicsDevice) {
...
//                FontBakerCharacterRange.Cyrillic
        ...
        public void LoadFromFile([NotNull] string fileName, [NotNull] Encoding encoding) {
        ...
        [NotNull, ItemNotNull]
        private static readonly Type[] SpriteFontConstructorTypes = {
