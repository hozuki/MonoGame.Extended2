...
// Comments for OpenMLD.Projector:
// This file has to be introduced because the .NET Standard version of MonoGame (MonoGame.Framework.OpenGL.Core)
// does not allow accessing OpenAL classes.
        ...
        */
        ...
        private static class ALHelper {
            ...
            internal static void CheckError(string message) {
                ...
                var errStr = AL.GetErrorString(error);
