...
namespace MonoGame.Extended.DesktopGL.VideoPlayback {
    ...
    public sealed class DecodingOptions {
        ...
        public DecodingOptions(int videoPacketQueueCapacity, int audioPacketQueueCapacity, int videoPacketQueueSizeThreshold, int audioPacketQueueSizeThreshold, FrameScalingMethod frameScalingMethod) {
