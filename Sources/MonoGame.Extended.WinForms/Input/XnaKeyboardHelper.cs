...
internal static class XnaKeyboardHelper
{

    internal static XKeys ToXna(Keys key)
    {
        return Map.TryGetValue(key, out var xkey) ? xkey : XKeys.None;
    }

    private static readonly IReadOnlyDictionary<Keys, XKeys> Map = new Dictionary<Keys, XKeys>
    {
        { Keys.A, XKeys.A },
        { Keys.Add, XKeys.Add },
